            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <form action="HotelServlet" method="POST" class="login-form">
                        ...
                        <div class="form-group d-flex">
                            <input type="text" name="fullname" id="fullname" class="form-control rounded-left" placeholder="Full name" required>
                        </div>
                        <div class="form-group d-flex">
                            <input type="text" name="email" id="email" class="form-control rounded-left" placeholder="Email" required>
                        </div>
                        <div class="form-group d-flex">
                            <input type="text" name="phone" id="phone" class="form-control rounded-left" placeholder="Phone" required>
                        </div>
                        <div class="form-group d-md-flex">
                            <div class="w-75 text-md-right">
                                <a href="login.jsp">Already have an account ? Log in now</a>
                            </div>
                        </div>
                        <div class="form-group">

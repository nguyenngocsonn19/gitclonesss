            ...
            <div class="row g-4">
                ...
                <c:forEach var="hotel" items="${requestScope.HOTEL_LIST}">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden" style="
                        max-height: 600px;
max-width: 300px;
display: block;
">
                            <div class="position-relative">
                                <img src="img/${hotel.img}" style="  display: block;
  margin-left: auto;
  margin-right: auto;
  display: block;
  margin:  0 auto;
   width: 100%;
    height: 100%;
  max-width: 600px; /* Kích thước cố định */
  max-height: 300px";
                                ...
                                <h6 class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">
                                        ${hotel.hotel_name}
                                </h6>
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a type="button" href="HotelServlet?command=DETAILS&hotel_id=${hotel.hotel_id}" class="btn btn-sm btn-outline-secondary" style="height: 31px">Details</a>
